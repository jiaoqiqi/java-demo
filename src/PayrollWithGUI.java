...
public class Payroll {
    public static  void main(String []args){
        ...
        double StateWithholdig = grossPay * Double.parseDouble(stateTax);
        double totalDeduction = federalWithholding+StateWithholdig;
        ...
        JOptionPane.showMessageDialog(null,"State Withholding(" + Double.parseDouble(federalTax)*100 + "%):  $" +  StateWithholdig);
